var e=[{id:`all`,label:`전체`,color:`#6366F1`,icon:`fa-solid fa-list`},{id:`counseling`,label:`직업상담학`,color:`#3B82F6`,icon:`fa-solid fa-comments`},{id:`psychology`,label:`직업심리학`,color:`#8B5CF6`,icon:`fa-solid fa-brain`},{id:`jobinfo`,label:`직업정보론`,color:`#10B981`,icon:`fa-solid fa-circle-info`},{id:`labor_market`,label:`노동시장론`,color:`#F59E0B`,icon:`fa-solid fa-chart-line`}],t=[{num:1,category:`counseling`,title:`부처(Butcher)의 집단 직업상담의 과정 3단계 모델에 대해 쓰고 설명하시오.`,frequency:`24-3, 22-3, 21-3, 21-1, 20-2`,keyword:`부처(Butcher) 집단직업상담 3단계`,answer:`<ol>
...
</ol>`}];function n(e){return!e||e===`all`?t:t.filter(t=>t.category===e)}function r(){let n={};for(let r of e)r.id!==`all`&&(n[r.id]=t.filter(e=>e.category===r.id).length);return n.all=t.length,n}export{n as i,t as n,r,e as t};