...
export const SILGI_EXAMS = [
  {
    id: '2023-3',
    year: 2023,
    round: 3,
    title: '2023년 제3회 직업상담사 실기',
    totalPoints: 100,
    questions: [
      {
        num: 1,
        title: '현재 사용되고 있는 흥미검사의 종류 5가지를 쓰시오.',
        points: 5,
        frequency: '23-3, 20-4, 12-2',
        keyword: '흥미검사의 종류',
        answer: `<ol>
<li>직업선호도검사(워크넷)</li>
...
<li>쿠더 직업흥미검사</li>
        ...
        advanced: `<p><strong>직업흥미검사의 종류</strong></p>
<ol>
...
<li>청소년 직업흥미검사(워크넷)</li>
      ...
      {
        num: 2,
        title: '행동주의 직업상담의 상담기법은 크게 불안감소기법과 학습촉진기법의 유형으로 구분할 수 있다. 각 유형별 대표적인 방법을 각각 3가지 쓰시오.',
        points: 6,
        frequency: '23-3, 22-1, 16-3, 16-2, 15-2, 15-1, 12-3, 11-1',
        keyword: '불안감소기법과 학습촉진기법',
        answer: `<h4>불안감소기법</h4>
<ol>
...
<li><strong>토큰법</strong> : 내담자의 바람직한 행동이 일어날 때 원하는 다양한 물건과 교환할 수 있는 강화물로 토큰이 주어지는 체계적인 강화기법이다.</li>
        ...
        tips: '출제빈도가 높은 문제입니다. 반드시 숙지하세요. 제시된 답안 중 3가지씩만 쓰시면 됩니다.',
        partialScore: '각 1점',
      },
      {
        num: 3,
        title: '진로상담 과정에서 관계수립을 위한 기본 상담기술 5가지를 기술하시오.',
        points: 5,
        frequency: '23-1, 20-1, 05-3',
        keyword: '기본 상담기술',
        answer: `<ol>
...
<li><strong>수용</strong> : 내담자의 이야기에 주의 집중하고 내담자를 인격적으로 존중하는 기법이다.</li>
      ...
      {
        num: 4,
        title: '성향검사의 종류를 6가지 쓰시오.',
        points: 6,
        frequency: '23-3',
        keyword: '성향검사(습관적 수행검사)',
        answer: `<ol>
<li>성격유형검사(MBTI)</li>
...
<li>직무만족도 검사</li>
        ...
        advanced: `<p><strong>성향검사의 분류</strong></p>
<ul>
...
<li><strong>태도검사</strong> : 직무만족도 검사, 구직욕구검사</li>
      ...
      {
        num: 5,
        title: '내담자 중심 상담을 성공적으로 이끌기 위해 상담자가 갖춰야 할 기본적인 태도 3가지를 설명하시오.',
        points: 6,
        frequency: '23-3, 16-1, 15-3, 15-1, 09-3, 07-3, 06-1',
        keyword: '내담자중심 상담의 상담자 태도',
        answer: `<ol>
...
<li><strong>공감적 이해</strong><br/>내담자의 감정과 경험을 마치 상담자 자신의 경험인 것처럼 이해하고자 하는 태도이다.</li>
        ...
        advanced: null,
        tips: '기출빈도가 높은 문제입니다. 반드시 숙지하세요.',
        partialScore: '각 2점, 설명이 없으면 1점',
      },
      {
        num: 6,
        title: '규준의 종류 중 백분위 점수(percentile score), 표준점수(standard score), 표준등급(stanine scale)의 의미를 각각 설명하시오.',
        points: 6,
        frequency: '23-1·2·3, 21-2, 19-1, 18-3, 17-3, 15-1, 14-3, 12-2, 12-3, 10-4, 09-10, 09-3, 08-1, 07-1',
        keyword: '집단 내 규준',
        answer: `<ol>
...
<li><strong>표준등급</strong><br/>9등급 또는 스테나인 점수라고 하며, 원점수를 1~9등급까지 범주로 나누는 것이다.</li>
        ...
        advanced: null,
        tips: '매우 기출빈도가 높은 문제입니다. 반드시 숙지하세요.',
        partialScore: '각 2점, 설명이 없으면 1점',
      },
      {
        num: 7,
        title: '다음은 준거타당도에 관한 사항이다. 물음에 답하시오.',
        points: 7,
        frequency: '23-3',
        keyword: '준거타당도',
        answer: `<h4>(1) 준거타당도의 종류 2가지</h4>
<ol>
...
<li>준거측정치의 신뢰도</li>
        ...
        advanced: `<p>실제연구가 아닌 실증연구에서 타당도가 낮아지는 이유는 준거타당도의 크기에 영향을 미치는 요인과 같습니다.</p>
<ol>
<li>표집오차</li>
<li>범위제한</li>
<li>준거측정치의 타당도</li>
...
<li>실제 연구는 실증연구에 비해 내적 타당도가 취약하다.</li>
        ...
        tips: '준거타당도는 출제 빈도가 높은 문제입니다. 숙지하시길 바랍니다. 또한 문제에서 \'실제(현장)연구의 타당도\'를 묻는지 \'실증(실험실)연구의 타당도\'를 묻는지에 따라 답안이 달라질 수 있습니다.',
        partialScore: '각 1점',
      },
      {
        num: 8,
        title: '실험실 연구의 장점 3가지를 쓰시오.',
        points: 6,
        frequency: '23-3',
        keyword: '실험실(실증) 연구',
        answer: `<ol>
...
<li>인과관계가 잘 설명되어 내적 타당성이 높다.</li>
        ...
        advanced: `<p><strong>현장(실제)연구</strong></p>
<p>현장 연구는 현장에서 이루어지는 연구로 독립변인을 조작하지 않고 현장에서 면접, 설문조사, 관찰 등을 이용해서 이루어지는 연구를 말하는 것으로 관련 방법으로는 전수조사, 표본조사, 참여관찰법 등이 있고 현장 실험처럼 외적타당도가 높다.</p>`,
        tips: null,
        partialScore: '각 2점',
      },
      {
        num: 9,
        title: '질문지법(설문법)의 장점과 단점을 각각 2가지씩 쓰시오.',
        points: 4,
        frequency: '23-3',
        keyword: '직무분석의 질문지법(설문법)',
        answer: `<h4>장점</h4>
<ol>
...
<li>직무수행에 요구되는 지식, 기술, 능력들이 얼마나 자주 사용되는지, 얼마나 중요한지 등을 평가한다.</li>
      ...
      {
        num: 10,
        title: '홀랜드(Holland) 직업흥미검사의 6가지 유형을 쓰고, 각각에 대해 간략히 설명하시오.',
        points: 6,
        frequency: '23-3, 23-2, 23-1, 22-1, 19-2, 18-2, 16-1, 14-3, 09-1, 08-1, 07-1, 04-1',
        keyword: '홀랜드(Holland)의 흥미유형',
        answer: `<ol>
...
<li><strong>관습형</strong> : 자료를 잘 정리하고 순응적이며 책임감이 강한 반면, 변화에 약하고 융통성이 부족하다.</li>
        ...
        advanced: null,
        tips: '출제빈도가 높은 문제입니다. 반드시 숙지하세요.',
        partialScore: '각 1점',
      },
      {
        num: 11,
        title: '인지·정서적 상담에서 인간에 대한 기본가정, 기본개념, 상담의 목표를 쓰시오.',
        points: 6,
        frequency: '23-3, 20-4, 12-2',
        keyword: '인지·정서 상담',
        answer: `<h4>(1) 인간에 대한 기본가정</h4>
<ol>
...
<li>자기관심, 자기수용, 불확실성의 수용, 관용, 융통성 등을 통해 자기 책임감 등 합리적인 신념의 변화를 유도한다.</li>
      ...
      {
        num: 12,
        title: '정신역동 직업상담 모형을 구체화시킨 보딘의 3단계 직업상담과정을 쓰고 각각에 대해 설명하시오.',
        points: 6,
        frequency: '23-3, 20-3, 18-2, 17-3, 15-3, 12-1',
        keyword: '보딘(Bordin)의 직업상담과정',
        answer: `<ol>
...
<li><strong>변화를 위한 노력의 단계</strong><br/>자신의 선택한 직업이 필요로 하는 부분에 대하여 변화를 모색하고 자신의 성격, 욕구 등을 변화시키고자 하는 노력의 단계이다.</li>
        ...
        advanced: null,
        tips: null,
        partialScore: '각 2점, 설명이 없으면 각 1점',
      },
      {
        num: 13,
        title: '내담자와의 초기면담 수행 시 상담자가 유의해야 할 사항 4가지를 쓰시오.',
        points: 4,
        frequency: '23-3, 20-3, 07-01, 07-02',
        keyword: '초기면담 수행 시 상담자 유의사항',
        answer: `<ol>
...
<li>과제물 부여하기</li>
  ...
  },
  {
    ...
    year: 2023,
    round: 2,
    title: '2023년 제2회 직업상담사 실기',
    totalPoints: 100,
    questions: [
      {
        num: 1,
        title: '보딘의 심리적 원인 5가지를 쓰고 설명하시오.',
        points: 10,
        frequency: '23-2, 21-1, 19-2, 18-3, 15-3, 14-1, 14-3, 13-3, 11-1, 10-2, 09-2, 06-1',
        keyword: '보딘(Bordin)의 심리적 원인',
        answer: `<ol>
...
<li><strong>진로선택의 불안</strong><br/>자신이 원하는 일과 중요한 타인의 요구가 다를 때 개인은 진로선택의 불안을 느끼게 된다.</li>
        ...
        advanced: null,
        tips: '이 문제는 빈출 문제를 확장한 문제로 여러 차례 3가지만 요구하다가 처음 5가지를 모두 쓰도록 요구한 문제입니다.',
        partialScore: '각 2점, 설명이 없으면 1점',
      },
      {
        num: 2,
        title: '롭퀴스트와 데이비스의 직업적응이론에서 직업적응방식의 유형 3가지를 쓰고 설명하시오.',
        points: 6,
        frequency: '23-2, 19-1',
        keyword: '직업적응방식',
        answer: `<ol>
...
<li><strong>융통성</strong> : 개인이 작업환경과 개인적 환경 간의 부조화를 참아내는 정도를 말한다.</li>
        ...
        advanced: null,
        tips: '이 문제는 기출 문제를 확장한 문제로 3가지 쓰기만 요구하다가 쓰고 설명하기를 요구한 문제입니다.',
        partialScore: '각 2점, 설명이 없으면 1점',
      },
      {
        num: 3,
        title: '틴슬레이와 브레들리(Tinsley & Bradley)가 제시한 검사 해석의 4단계를 설명하시오.',
        points: 4,
        frequency: '23-2, 20-4',
        keyword: 'Tinsley & Bradley의 검사 해석 4단계',
        answer: `<ol>
...
<li><strong>추후활동</strong><br/>상담결과에 대한 의견을 나누며 내담자가 그것을 어떻게 이해했는지 확인한다.</li>
        ...
        advanced: `<p><strong>틴슬레이와 브레들리가 제시한 검사 결과 검토의 2단계</strong></p>
<ol>
...
<li><strong>2단계 : 통합</strong><br/>이해를 통해 얻어진 검사 정보와 상담사가 수집한 내담자에 대한 다른 정보들과 통합한다.</li>
      ...
      {
        num: 4,
        title: 'Gottfredson의 직업과 관련된 개인발달의 4단계를 쓰고, 각각에 대해 설명하시오.',
        points: 4,
        frequency: '23-2, 16-3, 15-3, 11-3, 11-2',
        keyword: '고트프레드슨(Gottfredson)의 직업포부 발달단계',
        answer: `<ol>
...
<li><strong>내적, 고유한 자아 지향성</strong><br/>자아성찰과 사회계층의 맥락에서 직업적 포부가 더욱 발달하게 된다.</li>
        ...
        advanced: null,
        tips: null,
        partialScore: '각 1점, 설명이 없으면 0.5점',
      },
      {
        num: 5,
        title: '형태주의(게슈탈트) 상담의 상담기법을 4가지만 쓰시오.',
        points: 4,
        frequency: '23-2, 19-3, 18-2, 15-3, 13-2, 12-1, 11-1, 10-4',
        keyword: '게슈탈트(형태주의) 이론의 상담기법',
        answer: `<ol>
...
<li><strong>꿈 작업</strong> : 마치 꿈이 현재 사건인 것처럼 상상 꿈의 각 부분을 연기하게 한다.</li>
        ...
        advanced: `<p>게슈탈트(형태주의) 이론의 상담기법은 내담자 자신의 욕구와 감정을 자각시키는 방법들로 자각(알아차림)은 개체가 자신의 욕구나 감정을 지각한 다음 게슈탈트로 형성하여 전경으로 떠올리는 행위를 말한다. 이러한 알아차림은 누구에게나 자연적으로 갖추어져 있는 능력이다.</p>`,
        tips: '제시된 답안 중 4가지만 쓰시면 됩니다.',
        partialScore: '각 1점 (설명은 적지 않아도 됩니다.)',
      },
      {
        num: 6,
        title: 'Super의 발달단계 5단계를 쓰고, 각 단계에 대해 설명하시오.',
        points: 5,
        frequency: '23-2, 20-4, 19-2, 17-1, 09-2, 03-3',
        keyword: 'Super의 발달단계',
        answer: `<ol>
...
<li><strong>쇠퇴기</strong><br/>정신적·육체적으로 기능이 쇠퇴함에 따라 직업에서 은퇴하게 되어 새로운 역할과 활동을 찾게 되는 시기이다.</li>
      ...
      {
        num: 7,
        title: '구성타당도를 분석하는 대표적인 방법 2가지를 쓰고 설명하시오.',
        points: 4,
        frequency: '23-2, 19-3, 16-1, 15-1, 15-2, 10-1, 10-4, 09-3, 08-1, 06-3, 03-1, 03-3, 01-1',
        keyword: '구성타당도의 종류',
        answer: `<ol>
...
<li><strong>요인분석법</strong> : 검사 문항들 간의 상관관계를 분석하여 상관이 높은 문항들을 요인으로 묶어주는 통계방법</li>
        ...
        advanced: `<p><strong>다속성·다측정방법행렬표(MTMM)</strong> : 둘 이상의 특성에 대해 둘이상의 방법으로 측정하여 그 결과를 분석한 후 두 가지 측정결과가 어느 정도 상관관계가 있는지 알아보는 방법으로 순서는 수렴타당도의 시행 후 변별타당도 실시하고 다시 이 두 점수간의 상관관계를 본다.</p>`,
        tips: '변별타당도, 수렴타당도, 요인분석법 중 변별타당도, 수렴타당도 2가지를 답안으로 작성하시는 것을 추천 드립니다.',
        partialScore: '각 2점, 설명이 없으면 1점',
      },
      {
        num: 8,
        title: '직무평가방법 3가지를 쓰고 설명하시오.',
        points: 6,
        frequency: '23-2, 21-3',
        keyword: '직무평가방법',
        answer: `<ol>
...
<li><strong>요인(소)비교법</strong> : 가장 핵심이 되는 몇 개의 기준 직무를 선정하고 각 직무의 평가요소를 기준직무의 평가요소와 결부시켜 비교함으로써 모든 직무의 상대적 가치를 결정하는 방법이다.</li>
        ...
        advanced: `<p><strong>질적 평가방법</strong></p>
<ol>
...
<li>요인(소)비교법(factor comparison method)</li>
      ...
      },
      {
        ...
        title: '홀랜드(Holland) 직업흥미검사의 6가지 유형을 쓰고, 각각에 대해 간략히 설명하시오.',
        points: 6,
        frequency: '23-2, 23-1, 22-1, 19-2, 18-2, 16-1, 14-3, 09-1, 08-1, 07-1, 04-1',
        keyword: '홀랜드(Holland)의 흥미유형',
        answer: `<ol>
<li><strong>현실형</strong> : 기계, 도구, 동물에 관한 체계적인 조작활동을 좋아하며 현장 일을 선호하나 사회적 기술이 부족하다.</li>
<li><strong>탐구형</strong> : 호기심이 많고 분석적이여서 과학적 탐구활동을 선호하나 리더십 기술이 부족하다.</li>
...
<li><strong>관습형</strong> : 자료를 잘 정리하고 순응적이며 책임감이 강한 반면, 변화에 약하고 융통성이 부족하다.</li>
      ...
      {
        num: 10,
        title: '집단 내 규준의 종류 3가지를 쓰고 설명하시오.',
        points: 6,
        frequency: '23-2, 23-1, 21-2, 20-1, 19-1, 18-3, 17-3, 15-1, 14-3, 12-2, 12-3, 10-4, 09-10, 09-3, 08-1, 07-1',
        keyword: '집단 내 규준',
        answer: `<ol>
<li><strong>백분위 점수</strong><br/>개인이 표준화된 집단에서 차지하는 상대적 위치를 가리키는 것으로 개인의 점수를 100개의 동일한 구간에서 순위를 정한다.</li>
...
<li><strong>표준등급</strong><br/>9등급 또는 스테나인 점수라고 하며, 원점수를 1~9등급까지 범주로 나누는 것이다.</li>
      ...
      },
      {
        ...
        points: 6,
        frequency: '23-2, 21-3, 18-3, 18-1',
        keyword: '신뢰도를 추정하는 방법(종류)',
        answer: `<ol>
...
<li><strong>검사-재검사신뢰도</strong> : 시간차를 두고 동일검사를 반복 측정하는 방법이다.</li>
      ...
      {
        num: 12,
        title: '실존주의 상담자들이 내담자의 궁극적 관심사와 관련하여 중요하게 생각하는 주제를 3가지 쓰고 설명하시오.',
        points: 6,
        frequency: '23-2, 20-2, 17-2, 12-3, 10-2, 09-3',
        keyword: '실존주의의 궁극적 관심사',
        answer: `<ol>
...
<li><strong>무의미성</strong> : 인간은 인생을 살아가면서 끊임없는 삶의 의미를 추구한다.</li>
        ...
        advanced: `<p>이 문제는 두 가지 답안이 존재합니다. 제시된 해설 답안은 얄롬(Yalom)이란 학자가 제시한 답안이고 또 하나는 일반적인 실존주의 상담사들의 견해가 있습니다.</p>
...
<li><strong>죽음과 비존재</strong> : 삶과 죽음은 분리될 수 없는 연속성이며, 인간은 비존재에 대한 불안감을 가진다.</li>
        ...
        tips: '제시된 답안 중 3가지만 작성하시면 됩니다.',
        partialScore: '각 2점',
      },
      {
        num: 13,
        title: '내부노동시장의 형성요인 3가지를 쓰고 각각 설명하시오.',
        points: 6,
        frequency: '23-2, 18-1, 09-3',
        keyword: '내부노동시장의 형성요인',
        answer: `<ol>
...
<li><strong>기업 내의 관습</strong> : 근로자들 사이의 관습과 기업의 문화가 존재하여 기업의 내부노동시장을 발전시킨다.</li>
      ...
      {
        num: 14,
        title: '한국직업사전의 부가 직업정보 중 육체활동의 구분 5가지를 쓰시오.',
        points: 5,
        frequency: '23-2, 20-4',
        keyword: '한국직업사전 육체활동 구분',
        answer: `<ol>
<li>균형감각</li>
<li>웅크림</li>
<li>손사용</li>
...
<li>청각</li>
      ...
      {
        num: 15,
        title: '한국표준직업분류(KSCO)의 대분류와 직능수준의 관계를 묻는 표 안의 답란을 채우시오.',
        points: 5,
        frequency: '23-2, 21-1',
...
<tr><td>군인</td><td>제<strong>2</strong>직능수준 이상 필요</td></tr>
      ...
      {
        num: 16,
        title: '한국표준산업분류(KSIC)의 생산단위의 활동 형태 중 주된활동과 보조활동을 각각 설명하시오.',
        points: 6,
        frequency: '23-2, 22-3, 21-2',
        keyword: 'KSIC 생산단위 활동 형태',
        answer: `<ol>
...
<li><strong>보조활동(보조적 활동)</strong> : 모 생산단위에서 사용되는 비내구재 또는 서비스를 제공하는 활동을 말한다.</li>
      ...
      {
        num: 17,
        title: '실업과 관련된 제호다(Jahoda)의 박탈이론에 따르면 일반적으로 고용상태에 있는 것이 실직상태에 있는 것보다 여러 가지 잠재효과가 있다고 한다. 5가지 잠재효과를 기술하시오.',
        points: 6,
        frequency: '23-2, 05-3, 01-1',
        keyword: '제호다(Jahoda)의 박탈이론',
        answer: `<ol>
...
<li><strong>사회적 정체감과 지위</strong></li>
      ...
      {
        num: 18,
        title: '기혼여성의 경제활동참가율을 낮게 하는 요인 6가지를 쓰시오.',
        points: 6,
        frequency: '23-2, 14-2, 12-1, 11-3, 10-3, 07-1, 05-3, 03-1',
...
export function getExamById(id) {
  return SILGI_EXAMS.find((exam) => exam.id === id) || null;
}

/** 전체 시험 목록 (최신순) */
export function getExamList() {
  return [...SILGI_EXAMS].sort((a, b) => {
